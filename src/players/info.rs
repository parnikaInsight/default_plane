...
//     p2p_session: Option<Res<P2PSession<network::GGRSConfig>>>,
//     synctest_session: Option<Res<SyncTestSession<network::GGRSConfig>>>,
//     spectator_session: Option<Res<SpectatorSession<network::GGRSConfig>>>,
// ) {
